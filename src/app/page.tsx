...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Project your retirement savings using the 4% rule. See your gap or surplus instantly.",
  ...
  },
  {
    ...
    description:
      "Add all assets and liabilities to instantly calculate your total net worth.",
  ...
  },
  {
    ...
    description:
      "Compare avalanche vs snowball strategy. See exactly when you'll be debt-free.",
  ...
  },
  {
    ...
    description:
      "Plan your monthly budget by category. Checks your 50/30/20 rule compliance.",
  ...
  },
  {
    ...
    description:
      "Find out how long it takes to reach any savings goal with interest projections.",
  ...
  },
  {
    ...
    description:
      "Log daily start/end times for a full week. Auto-calculates regular and overtime hours.",
  ...
  },
  {
    ...
    description:
      "Calculate overtime pay at 1.5x, 2x, or any multiplier. Shows gross weekly pay.",
  ...
  },
  {
    ...
    description:
      "Find the minimum score you need on your final exam. Weighted grade average too.",
  ...
  },
  {
    ...
    description:
      "Calculate hours between any two times. Add multiple ranges, subtract breaks.",
  ...
  },
  {
    ...
    description:
      "Calculate selling price from cost and markup %. Includes markup vs margin reference table.",
  ...
  },
  {
    ...
    description:
      "Calculate TDEE and daily calorie targets for weight loss, maintenance, or gain.",
  ...
  },
  {
    ...
    description:
      "Add, subtract, multiply, and divide fractions. Shows step-by-step solutions.",
