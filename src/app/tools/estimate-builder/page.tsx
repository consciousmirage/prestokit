...
export default function EstimateBuilderPage() {
  ...
  /* status badge style for the preview */
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <select
                      ...
                      value={data.status}
                      onChange={(e) =>
                        set("status", e.target.value as EstimateStatus)
                      }
                    >
                    ...
                    <span
                      className={`shrink-0 inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-medium ${STATUS_COLORS_DARK[data.status]}`}
                    >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="This estimate is valid for 30 days from the date of issue. A 50% deposit is required to begin work. Final payment is due upon project completion."
                    value={data.terms}
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="text-right space-y-1">
                    {/* Status badge */}
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-semibold ${statusStyle.bg} ${statusStyle.text}`}
                    >
                      <span
